---
name: bergbot-help
description: Explain what Bergbot can do and offer four localised, seasonal prompt suggestions. Use on greeting, "what can you do", vague messages, or an empty prompt.
---
...
1. Run `bergbot suggest --lang LANG [--region xx]` → 4 numbered suggestions.
2. Reply (playful register): one line of what Bergbot does, the numbered suggestions, and "or just write what you
   have in mind". Slash commands exist (/find /around /audit /check /gpx /help) but are never required.
